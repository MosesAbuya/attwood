...
<head>
  <title>Client Testimonials &mdash; Attwood Travel Agency Ltd</title>
  <meta charset="utf-8">
...
<body>
  ...
  <section class="aw-page-hero"
    style="background-image:url('oldattwood/img/slider/slide5.jpg'); height: 500px; position:relative; background-size:cover; background-position:center;">
    <div class="overlay"
  ...
  <section class="section-pad bg-cream" style="padding: 80px 0;">
    <div class="container"
      ...
      <div class="rich-content">
        ...
        <p>At Attwood Travel Agency Ltd, our greatest achievement is not the awards we win or the accreditations we hold; it is
  ...
  <section class="fa-cta-banner"
    style="background-image:url('oldattwood/img/slider/slide1.jpg'); padding:100px 0; text-align:center; position:relative; background-size:cover; background-attachment:fixed;">
