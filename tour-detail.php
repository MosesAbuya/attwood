...
<head>
  ...
  <style>
    ...
    .tdv2-modal-backdrop.open { display: flex; animation: fadeUp 0.25s ease both; }
    .tdv2-modal-box {
      background: #fff;
      border-radius: 20px;
      width: 100%;
    ...
    .tdv2-modal-close:hover { background: rgba(255,255,255,0.3); }
    .tdv2-modal-body { padding: 28px; }
    ...
    .tdv2-inquire-btn:hover { background: var(--aw-primary-dark); transform: translateY(-2px); box-shadow: 0 10px 35px rgba(255,0,0,0.45); }
...
<div class="tdv2-modal-backdrop" id="enquiryModal">
  <div class="tdv2-modal-box">
    <div class="tdv2-modal-header">
      <div>
        <div class="tdv2-modal-title"><i class="fa fa-paper-plane" style="margin-right:8px; color:var(--aw-accent-gold);"></i>Enquire About This Tour</div>
        <div class="tdv2-modal-subtitle"><?= htmlspecialchars($tour['title']) ?> &bull; <?= $daysCount ?> Days / <?= $nights ?> Nights</div>
      </div>
