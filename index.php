...
<head>
  ...
  <meta name="description"
    content="Attwood Travel Agency Ltd   Kenya's premier safari and travel company. Book tailored safaris to Maasai Mara, beach holidays, honeymoon packages, family tours and more.">
...
<body>
  ...
  <div class="social-sidebar">
    <a href="https://www.facebook.com/share/16HsWzXEFA/" target="_blank" title="Facebook"><i
    ...
    <a href="https://www.linkedin.com/in/attwood-travel-agency-6a7978357" target="_blank" title="LinkedIn"><i
  ...
  <section class="aw-hero-sleek">
    ...
    <div class="container h-100 position-relative" style="z-index: 10;">
      <div class="row h-100 align-items-center justify-content-center text-center">
        <div class="col-12 col-md-10 col-lg-8 mt-5 aw-hero-content-col">
          <h1 class="aw-hero-title-sleek">Your Perfect Safari Escape</h1>
          <p class="aw-hero-subtitle-sleek mt-3">Experience the art of travel through our curated destinations.<br>Your
            unforgettable adventure begins here.</p>
        </div>
            ...
            <div class="aw-hero-search-glass">
              <form class="d-flex align-items-center flex-wrap flex-md-nowrap w-100" action="tours" method="GET"
                ...
                <div class="search-field">
                  <div class="sf-icon" style="margin-right: 10px;"><i class="fa fa-map-marker"></i></div>
                  <div class="sf-input-group" style="width: 100%;">
                    <input type="text" id="aw-dest-input" name="q" placeholder="Destination" autocomplete="off">
                  </div>
                  <div id="aw-search-results" class="aw-search-results-dropdown d-none"></div>
                </div>
                <div class="search-field">
                  <div class="sf-icon" style="margin-right: 10px;"><i class="fa fa-calendar"></i></div>
                  <div class="sf-input-group" style="width: 100%;">
                    <input type="text" name="month" style="color:#fff;" placeholder="Travel Dates"
                      onfocus="(this.type='month')">
                  </div>
                </div>
                <div class="search-field border-0">
                  <div class="sf-icon" style="margin-right: 10px;"><i class="fa fa-users"></i></div>
                  <div class="sf-input-group" style="position:relative; width: 100%;">
                    <select name="guests"
                      style="color:#fff; background: transparent; border: none; width: 100%; outline: none; appearance: none; -webkit-appearance: none; padding-right: 20px;">
                      <option value="" disabled selected style="color:#000;">Guests</option>
                    ...
                    <i class="fa fa-angle-down"
                      style="position:absolute; right:0; top:50%; transform:translateY(-50%); color:#fff; pointer-events:none;"></i>
                  </div>
                </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-7">
          <div class="aw-about-text">
            ...
            <p class="mt-3">While safety is core to how we operate, we're also focused on the fun factor and suitably
              challenging you to reach that great sensation of personal achievement while enjoying the camaraderie of
              like-minded travellers.</p>
            <p>We offer all-season holiday tours and safaris upon request. Our tour vehicles are perfectly maintained
              four-by-four (4×4) wheel drives equipped with modern binoculars, fridge compartments, a charging system,
              Wi-Fi, and radio calls guaranteeing an exceptional safari.</p>
  ...
  <section class="aw-hot-section">
    <div class="container" style="max-width:1280px;">
              ...
              <div class="aw-hot-body">
                ...
                <div class="aw-hot-footer">
                  <div>
                    ...
                    <div class="aw-hot-price-val"><?= $price ?> <del
                        style="font-size:12px;color:#999;font-weight:600;margin-left:4px;"><?php if (!empty($tour['price_from_usd']))
                          echo '$' . number_format($tour['price_from_usd'] * 1.15); ?></del>
                    </div>
      ...
      <div class="text-center mt-4">
        <a href="tours" class="aw-btn-bor" style="border-radius:20px;border-color:#ff6a1a;color:#ff6a1a!important;">View
          All Package</a>
      </div>
    </div>
  </section>
  ...
  <section class="aw-packages-section">
    <div class="container" style="max-width:1280px;">
      <div class="text-center mb-5">
        ...
        <span class="aw-section-line"></span>
        <p class="aw-section-sub" style="max-width:600px;margin:0 auto;">We craft experiences that go beyond the
          ordinary tailored to your passions, your pace, and your dreams.</p>
      </div>
      <div class="row">
        <!-- Card 1 -->
        <div class="col-md-4 mb-4 d-flex">
          <div class="aw-pkg-card w-100">
            ...
            <p>We offer all-season holiday tours and safaris upon request. Our tour vehicles are perfectly in new
              condition and all are four by four (4×4) wheel drives for guaranteed exceptional Safari. Also equipped
              with modern binoculars, fridge compartments, charging system, Wi-fi, and Radio calls.</p>
        ...
        <div class="col-md-4 mb-4 d-flex">
          <div class="aw-pkg-card w-100">
            ...
            <span class="aw-pkg-card-line"></span>
            <p>We offer a range of customizable tour packages to suit your interests, preferences, and budget. Whether
              you're looking for a romantic getaway, a family vacation, or a thrilling adventure, Attwood can design the
        ...
        <div class="col-md-4 mb-4 d-flex">
          <div class="aw-pkg-card w-100">
            ...
            <span class="aw-pkg-card-line"></span>
            <p>We are dedicated to promoting sustainable tourism practices and preserving the environment and local
              communities. We work closely with local communities to ensure that our tours positively impact the
              destinations they visit.</p>
            <a href="tours" class="aw-btn-bor">Read More</a>
          </div>
        </div>
      </div>
  ...
  <section class="aw-tours-section">
    <div class="container" style="max-width:1280px;">
      <div class="text-center mb-5">
        ...
        <span class="aw-section-line"></span>
        <p class="aw-section-sub">Handpicked adventures from the wild savannahs of Kenya to the turquoise coasts each
          journey crafted with passion.</p>
      </div>
      <div class="row">
          ...
          <div class="col-lg-4 col-md-6 mb-4 d-flex">
            <div class="aw-tour-card w-100">
              ...
              <div class="aw-tour-body">
                <div class="aw-tour-title"><a
                    href="tours/<?= $tour['slug'] ?? '' ?>"><?= htmlspecialchars($tour['title'] ?? '') ?></a></div>
    ...
    <div class="aw-testi-inner container" style="max-width:1000px;">
      ...
      <div id="aw-testi-carousel" class="owl-carousel aw-owl-testi">
        <div class="aw-testi-card">
          <p class="aw-testi-desc">Attwood Travel Agency offers personalized safari experiences tailored to your
            preferences. With expert local guides and seamless logistics, your journey will be safe, smooth, and
            unforgettable.</p>
        ...
        <div class="aw-testi-card">
          <p class="aw-testi-desc">We provide affordable, all-inclusive travel packages with no hidden costs. Our 24/7
            customer support ensures you're never alone while exploring your dream destinations.</p>
          <span class="aw-testi-line d-block"></span>
          <div class="aw-testi-name">Transparent Pricing</div>
          <div class="aw-testi-role">No Surprises, Ever</div>
        </div>
        <div class="aw-testi-card">
          <p class="aw-testi-desc">From Maasai Mara to the Maldives, from Zanzibar to Dubai we bring the world's most
            iconic destinations to your doorstep with expert planning and unrivalled care.</p>
          <span class="aw-testi-line d-block"></span>
  ...
  <section class="aw-dest-section">
    <div class="container" style="max-width:1280px;">
      <div class="text-center mb-5">
        ...
        <span class="aw-section-line white"></span>
        <p class="aw-section-sub white" style="max-width:560px;margin:0 auto;">From Kenya's wild savannahs to Indian
          Ocean paradise explore where we take you.</p>
      </div>
    </div>

    <div class="aw-dest-carousel-outer" style="position:relative;max-width:1280px;margin:0 auto;padding:0 60px;">
      <button class="aw-hero-arrow prev aw-dest-prev" aria-label="Previous" style="left:0;"><i
          class="fa fa-arrow-left"></i></button>
      <button class="aw-hero-arrow next aw-dest-next" aria-label="Next" style="right:0;"><i
          class="fa fa-arrow-right"></i></button>

      <div style="overflow:hidden;">
        <div class="aw-dest-track"
          ...
          <?php foreach ($countries as $dest):
            ...
            if (in_array($cL, ['maldives', 'sri lanka', 'indonesia', 'bali']))
              $region = 'Asia';
            elseif (in_array($cL, ['uae', 'united arab emirates', 'dubai', 'oman', 'qatar']))
              $region = 'Middle East';
            elseif (in_array($cL, ['france', 'italy', 'greece', 'spain', 'uk']))
              $region = 'Europe';
            elseif (in_array($cL, ['seychelles', 'mauritius', 'madagascar']))
              $region = 'Indian Ocean';
            ?>
              ...
              <a href="country.php?name=<?= urlencode($cName) ?>" class="aw-dest-card">
                ...
                <div class="aw-dest-info">
                  ...
                  <?php if ($dest['tour_count'] > 0): ?>
                    <div class="aw-dest-badge-hover"><?= $dest['tour_count'] ?>
                      Tour<?= $dest['tour_count'] > 1 ? 's' : '' ?></div>
                  <?php endif; ?>
                </div>
              </a>
            </div>
    ...
    <div class="container" style="max-width:1280px;">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 offset-lg-1">
          ...
          <span class="aw-section-line"></span>
          <p class="aw-section-sub mb-4">We are not just a travel agency we are your personal journey curator. Every
            adventure begins with understanding you: your pace, your passions, your dream.</p>
          ...
          <div class="aw-why-feature">
            ...
            <div class="aw-why-feature-text">
              ...
              <p>Every detail the lodges, the guides, the pace shaped entirely around your wishes. No two Attwood
                journeys are the same.</p>
            </div>
          </div>
          ...
          <div class="aw-why-feature">
            ...
            <div class="aw-why-feature-text">
              ...
              <p>Born from the African bush, our team's knowledge comes from years on the ground across Kenya's national
          ...
          <div class="aw-why-feature">
            ...
            <div class="aw-why-feature-text">
              ...
              <p>We partner with eco-certified lodges and contribute to community conservation on every safari we
                conduct.</p>
            </div>
          </div>
          ...
          <div class="aw-why-feature">
            ...
            <div class="aw-why-feature-text">
              ...
              <p>Our team is always available before, during, and after your journey to ensure everything runs
                perfectly.</p>
            </div>
          </div>
  ...
  <section class="aw-cta-band text-center">
    <div class="container" style="max-width:900px;">
      ...
      <p>Ready to turn your dream holiday into reality? Speak with an Attwood specialist today let us craft your perfect
        journey.</p>
      <div class="aw-cta-buttons" style="display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
        <a href="contact" class="aw-btn-red" style="font-size:16px;padding:14px 36px;">Request Now <i
