...
<?php include('include/header.php');?>
  ...
  <div class="blog-head-img text-center">
    <div class="blog-head-img-black">
      <div class="container">
        <h2>We love to see you smile</h2>
        <p>Restora. Good food. Good cheer. Good times.</p>
        <span><a href="index.php">HOME</a> > <a href="#">PAGES</a> > <b class="content-subhead">BLOG</b></span> </div>
    </div>
  </div>
  ...
  <!-- Image -->
  <img id="sliderImage" src="img/blog-1.jpg" 
  ...
  setInterval(() => {
    changeSlide(1);
        ...
        <div>
          ...
          <p class="article-body-span" style="margin-right:0; margin-top:15px;">We’ve long believed that good food, good eating, is all about risk. Whether we’re talking about unpasteurized Stilton, raw oysters or working for organized crime ‘associates’, food, for me, has always been an adventure</p>
          <a class="article-read btn-bg" href="blog-post.html">Book Now</a>
