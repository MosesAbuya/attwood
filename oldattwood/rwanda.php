...
<section id="page-title" style="background: url('img/rwa3.jpg') center center no-repeat; background-size: cover;">
  <div class="story-head text-center">
    <div class="story-head-black">
      <div class="container">
        <h2>Rwanda Packages</h2>
        <p>Make People Fullfill their dreams!</p>
        <span><a href="index.php">HOME</a> > <a href="#">Rwanda Packages</a> > <b class="content-subhead">Welcome</b></span> </div>
    </div>
  </div>
</section>
  <!--TOP-->
  ...
  <!-- Image -->
  <img id="sliderImage" src="img/rwa1.jpg" 
...
<script>
  const images = ["img/rwa1.jpg", "img/rwa2.jpg", "img/rwa3.jpg"];
  let currentIndex = 0;
  ...
  setInterval(() => {
    changeSlide(1);
        ...
        <div>
          ...
          <h3>Discover Details About Rwanda Packages</h3>
      
          <p class="article-body-span" style="margin-right:0; margin-top:15px;">Discover the “Land of a Thousand Hills” with our captivating Rwanda tour packages, ideal for travelers seeking both natural beauty and rich cultural experiences. Our curated trips include unforgettable gorilla trekking adventures in Volcanoes National Park, where you can come face-to-face with endangered mountain gorillas in their lush forest habitat. Explore the stunning landscapes of Nyungwe Forest with its canopy walk and rare primates, or enjoy a game drive in Akagera National Park, where lions, elephants, and hippos roam freely.</p>

          <p class="article-body-span">Rwanda is also a place of healing and heritage. Visit the Kigali Genocide Memorial to understand the country’s powerful history, then explore the vibrant city of Kigali known for its cleanliness, hospitality, and thriving arts scene. Whether you're looking for adventure, wildlife, or cultural immersion, our Rwanda packages are crafted to provide a seamless, enriching, and memorable journey.</p>
