...
<section id="page-title" style="background: url('img/slider/slider-2.jpg') center center no-repeat; background-size: cover;">
  <div class="event-head-img text-center">
    <div class="event-head-img-black">
      <div class="container">
        <h2>The Car Hire</h2>
        <p>Get to Know More</p>
        <span><a href="index.php">HOME</a> > <a href="#">Car Hire</a> > <b class="content-subhead">The Car Hire</b></span> </div>
    </div>
  </div>
</section>
  ...
  <div class="container padd-70">
    <div class="col-md-12 text-center events">
      <h2 class="content-subhead">Our Car Hire</h2>
      <p class="events-p">We are currently providing car hire services in Kenya. We are also handling airport and SGR train ticket booking for both international and local visitors. We are committed in offering unexceptional rates and services to all our clients. We have several vehicles in our fleet, ranging from 7 seater vans, 8 seater luxury minibuses, 10 & 14 seater luxury minibuses as well as 22 and 28 seater luxury and semi-luxury coaches for the larger groups. The vehicle allocated to a particular transfer will depend on the schedule on the particular day and number of persons. Therefore, if you’re an executive traveling on an important tour, or a family vacationing or friends enjoying, we have something for everybody. Our drivers are very reliable and experienced. They know their way around Kenya very well. So, be confident that you are in safe hands and will reach your desired destination on time thus enjoying your moment well.</p>
  ...
  <section class="portfolio on-portfolio padd-50" style="margin-top:0;">
    <div class="container">
      
      <div class="row" id="portfolio-grid"> 
        <!--1--> 
        <a href="#" type="button" data-toggle="modal" data-target="#myModal">
        <div class="item col-md-3 col-sm-6 col-xs-12 Vegetarian">
          <figure> <img alt="1-image" src="img/Gallery/car1.jpg" class="img-responsive">
            <figcaption> <i class="fa fa-plus" aria-hidden="true"></i> </figcaption>
          </figure>
        </div>
        </a> 
        <!-- Modal -->
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <h4 class="modal-title">Car hire</h4>
              <div class="modal-body text-center"> <img src="img/Gallery/car1.jpg" class="img-responsive" /> </div>
            </div>
          </div>
        </div>
        
        <!--2--> 
        <a href="#" type="button" data-toggle="modal" data-target="#myModal-2">
        <div class="item col-md-3 col-sm-6 col-xs-12 Chinese">
          <figure> <img alt="1-image" src="img/Gallery/car2.jpg" class="img-responsive">
            <figcaption> <i class="fa fa-plus" aria-hidden="true"></i> </figcaption>
          </figure>
        </div>
        </a> 
        ...
        <div class="modal fade" id="myModal-2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <h4 class="modal-title">Car hire</h4>
              <div class="modal-body text-center"> <img src="img/Gallery/car2.jpg" class="img-responsive" /> </div>
            </div>
          </div>
        </div>
        <!--3--> 
        <a href="#" type="button" data-toggle="modal" data-target="#myModal-3">
        <div class="item col-md-3 col-sm-6 col-xs-12 Vegetarian">
          <figure> <img alt="1-image" src="img/Gallery/car3.jpg" class="img-responsive">
            <figcaption> <i class="fa fa-plus" aria-hidden="true"></i> </figcaption>
          </figure>
        </div>
        </a> 
        ...
        <div class="modal fade" id="myModal-3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <h4 class="modal-title">Car Hire</h4>
              <div class="modal-body text-center"> <img src="img/Gallery/car3.jpg" class="img-responsive" /> </div>
            </div>
          </div>
        </div>
        <!--4--> 
        <a href="#" type="button" data-toggle="modal" data-target="#myModal-4">
        <div class="item col-md-3 col-sm-6 col-xs-12 Chinese">
          <figure> <img alt="1-image" src="img/Gallery/car4.jpg" class="img-responsive">
            <figcaption> <i class="fa fa-plus" aria-hidden="true"></i> </figcaption>
          </figure>
        </div>
        </a> 
        ...
        <div class="modal fade" id="myModal-4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <h4 class="modal-title">Car Hire</h4>
              <div class="modal-body text-center"> <img src="img/Gallery/car4.jpg" class="img-responsive" /> </div>
            </div>
          </div>
        </div>
        <!--5--> 
        ...
        <!-- Modal -->
        <div class="modal fade" id="myModal-16" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <h4 class="modal-title">Menu title</h4>
              <div class="modal-body text-center"> <img src="img/gallery-tab-16.jpg" class="img-responsive" /> </div>
            </div>
          </div>
        </div>
      </div>
