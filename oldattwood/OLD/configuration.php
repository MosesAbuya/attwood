...
class JConfig
{
	...
	public $db = 'attwoodt_db';
	public $dbencryption = '';
	public $dbprefix = 'dboss_';
	public $dbsslca = '';
	public $dbsslcert = '';
	public $dbsslcipher = '';
	public $dbsslkey = '';
	...
	public $force_ssl = '2';
	public $fromname = 'Attwood Travel Agency Limited';
	...
	public $live_site = 'https://www.attwoodtravelagency.co.ke/';
	public $log_categories = '';
	public $log_category_mode = '0';
	public $log_deprecated = '0';
	public $log_everything = '0';
	public $log_path = '/home3/attwoodt/public_html/administrator/logs';
	public $log_priorities = array (
'0' => 'all'
);
	public $mailer = 'mail';
	public $mailfrom = 'info@attwoodtravelagency.co.ke';
	public $mailonline = '1';
	public $massmailoff = '';
	...
	public $replytoname = '';
	public $robots = '';
	public $secret = 'yNgn32bUpntu6GzzECNUpssb4YA6EE6g';
	public $sef = '1';
	public $sef_rewrite = '';
	public $sef_suffix = '';
	...
	public $sitename = 'Attwood Travel Agency Limited';
	...
	public $smtpuser = '';
	public $tmp_path = '/home3/attwoodt/public_html/tmp';
	public $unicodeslugs = '';
	public $user = 'attwoodt_user';
}
