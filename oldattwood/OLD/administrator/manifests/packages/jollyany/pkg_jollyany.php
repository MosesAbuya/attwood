...
if (!class_exists('pkg_jollyanyInstallerScript')) {
    class pkg_jollyanyInstallerScript {
        ...
        public function displayAstroidWelcome($parent) {
            ...
            <div class="astroid-install">
                <img src="<?php echo JURI::root() . 'media/templates/site/tz_interiart/images/banner.png'; ?>" alt="astroid-logo" />
                <div class="install-message">
                    <h3>InteriArt | Furniture & Interior Joomla Template
                        <span>v <?php echo $parent->manifest->version; ?></span>
                    </h3>
                    <p>Interiart a clean, modern but user friendly Joomla template which is considered to a full solution for Interior, Architecture and Furniture site.</p>
                </div>
