...
if ($paddingCustom) {
    $doc -> addStyleDeclaration('.tplMaya .tp-item-box-container {padding: '.$paddingCustom.';}.tplMaya #portfolio' . $module->id . ' {margin-left: -'.$paddingCustom.';margin-right: -'.$paddingCustom.';}');
}
...
if ($list):
    ?>
    <div id="TzContent<?php echo $module->id; ?>" class="tz_portfolio_plus_portfolio<?php echo $moduleclass_sfx;?> tplMaya TzContent">
            ...
            <div id="tz_options<?php echo $module -> id;?>" class="clearfix">
                <div class="option-combo">
                    <div id="filter<?php echo $module->id;?>" class="option-set clearfix" data-option-key="filter">
                        <a href="#show-all" data-option-value="*" class="btn btn-default btn-outline-secondary btn-small selected"><?php echo JText::_('MOD_TZ_PORTFOLIO_PLUS_PORTFOLIO_SHOW_ALL');?></a>
                        <?php if($params->get('tz_filter_type','categories') == 'tags' && $filter_tag):?>
                            <?php foreach($filter_tag as $i => $itag):?>
                                <a href="#<?php echo $itag -> alias; ?>"
                                   class="btn btn-default btn-outline-secondary btn-small"
