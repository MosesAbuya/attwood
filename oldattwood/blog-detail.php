  ...
  <div class="story-head text-center">
    <div class="story-head-black">
      <div class="container">
        ...
        <span><a href="index.php">HOME</a> > <a href="#">Blog Details</a> > <b class="content-subhead">Welcome</b></span> </div>
    </div>
  </div>
</section>
...
<?php if (isset($row)) { ?>
  ...
  <a id="facebookShare" target="_blank" class="social-btn facebook" title="Share on Facebook">
    <i class="fab fa-facebook-f"></i>
  </a>
  <a id="whatsappShare" target="_blank" class="social-btn whatsapp" title="Share on WhatsApp">
    <i class="fab fa-whatsapp"></i>
  </a>
  <a id="linkedinShare" target="_blank" class="social-btn linkedin" title="Share on LinkedIn">
    <i class="fab fa-linkedin-in"></i>
  </a>
  <a href="https://www.instagram.com/yourusername/" target="_blank" class="social-btn instagram" title="Visit Instagram Page">
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 padd-70">
      <div class="col-md-12">
        <div class="categories">
          <h3 class="content-subhead" style="color: red;">Other Blogs</h3>
    ...
    <div class="container" style="padding-top:20px; padding-bottom:20px;">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 footer-pay-p">
          <p>©2017 <b class="content-subhead">Attwood Travel Agency</b>. All Rights Reserved.</p>
        </div>
...
<script>
  ...
  document.getElementById('whatsappShare').href = `https://wa.me/?text=${currentURL}`;
