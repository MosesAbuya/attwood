...
<section id="page-title" style="background: url('img/mala1.jpg') center center no-repeat; background-size: cover;">
  <div class="story-head text-center">
    <div class="story-head-black">
      <div class="container">
        <h2>Malawi Packages</h2>
        <p>Make People Fullfill their dreams!</p>
        <span><a href="index.php">HOME</a> > <a href="#">Malawi Packages</a> > <b class="content-subhead">Welcome</b></span> </div>
    </div>
  </div>
</section>
  <!--TOP-->
  ...
  <!-- Image -->
  <img id="sliderImage" src="img/mala1.jpg" 
...
<script>
  const images = ["img/mala1.jpg", "img/mala2.jpg", "img/mala3.jpg"];
  let currentIndex = 0;
  ...
  setInterval(() => {
    changeSlide(1);
        ...
        <div>
          ...
          <h3>Discover Details About Malawi Packages</h3>
      
          <p class="article-body-span" style="margin-right:0; margin-top:15px;">Experience the warm heart of Africa with our exclusive Malawi tour packages, offering serene lake adventures, rich wildlife encounters, and cultural immersion. Relax along the golden beaches of Lake Malawi, Africa’s third-largest lake, where crystal-clear waters are perfect for snorkeling, kayaking, or simply unwinding in the sun. Explore the charming towns of Cape Maclear and Nkhata Bay, known for their friendly locals, vibrant markets, and picturesque sunsets that make Malawi a hidden gem for leisure travelers.</p>

          <p class="article-body-span">For nature lovers, Malawi offers more than just lakeside bliss. Discover Majete Wildlife Reserve and Liwonde National Park, where safaris reveal elephants, hippos, antelopes, and rare black rhinos. Hike the scenic trails of Mount Mulanje or Nyika Plateau for breathtaking views and endemic flora. With its blend of peaceful beauty, authentic experiences, and welcoming people, our Malawi packages promise an unforgettable African journey like no other.</p>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 padd-70">
      <div class="col-md-12">
        <div class="categories">
          ...
          <span></span>
          <ul>
            <li><a href="kenya.php"><i class="fa fa-angle-right content-subhead" aria-hidden="true"></i>&nbsp; Kenya Packages</a></li>
            <li><a href="rwanda.php"><i class="fa fa-angle-right content-subhead" aria-hidden="true"></i>&nbsp; Rwanda Packages </a></li>
            <li><a href="uganda.php"><i class="fa fa-angle-right content-subhead" aria-hidden="true"></i>&nbsp; Uganda Packages </a></li>
            <li><a href="tanzania.php"><i class="fa fa-angle-right content-subhead" aria-hidden="true"></i>&nbsp; Tanzania Packages </a></li>
            <li><a href="malawi.php"><i class="fa fa-angle-right content-subhead" aria-hidden="true"></i>&nbsp; Malawi Packages. </a></li>
