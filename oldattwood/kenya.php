  ...
  <div class="story-head text-center">
    <div class="story-head-black">
      <div class="container">
        ...
        <span><a href="index.php">HOME</a> > <a href="#">Kenya Packages</a> > <b class="content-subhead">Welcome</b></span> </div>
    </div>
  </div>
</section>
  <!--TOP-->
  ...
  setInterval(() => {
    changeSlide(1);
        ...
        <div>
          ...
          <p class="article-body-span" style="margin-right:0; margin-top:15px;">Kenya is a premier travel destination famed for its breathtaking landscapes, diverse wildlife, and rich cultural heritage. At Attwood Travel Agency, we offer curated Kenyan packages that take you deep into the heart of this vibrant country. Explore the iconic Maasai Mara National Reserve, world-renowned for the Great Wildebeest Migration and thrilling Big Five safaris. Discover the flamingo-lined shores of Lake Nakuru, the dramatic escarpments of the Great Rift Valley, and the snow-capped peaks of Mount Kenya. For beach lovers, unwind along the pristine white sands of Diani, Watamu, or Malindi, where the turquoise Indian Ocean awaits.</p>

          <p class="article-body-span">Our Kenyan tour packages cater to all types of travelers—from luxury seekers to adventurous backpackers and families. Visit the bustling capital, Nairobi, home to the Giraffe Centre and David Sheldrick Elephant Orphanage. Enjoy cultural experiences with the Maasai, Samburu, and other indigenous communities. Whether you're looking for a romantic getaway, wildlife expedition, or a family holiday, Attwood ensures a seamless and memorable Kenyan adventure tailored just for you. Let us help you explore the magic of Kenya!</p>
