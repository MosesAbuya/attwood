  ...
  <div class="story-head text-center">
    <div class="story-head-black">
      <div class="container">
        ...
        <span><a href="index.php">HOME</a> > <a href="#">Murchison Falls</a> > <b class="content-subhead">Welcome</b></span> </div>
    </div>
  </div>
</section>
  <!--TOP-->
  ...
  setInterval(() => {
    changeSlide(1);
        ...
        <div>
          ...
          <p class="article-body-span" style="margin-right:0; margin-top:15px;">Murchison Falls National Park, Uganda’s largest and most iconic park, offers an unforgettable blend of wildlife, scenic beauty, and the roaring power of nature. At the heart of the park lies the dramatic Murchison Falls, where the mighty Nile River forces its way through a narrow 7-meter gorge, creating a breathtaking cascade. Visitors can enjoy boat safaris along the river, witnessing crocodiles basking in the sun, pods of hippos bobbing in the water, and a rich variety of birdlife including the rare shoebill stork.</p>

          <p class="article-body-span">This diverse park is home to Africa’s "Big Five"—lion, leopard, elephant, buffalo, and rhino (at the nearby Ziwa Rhino Sanctuary)—making it a prime safari destination. Explore the vast savannahs teeming with giraffes, antelopes, and warthogs on a game drive, or take a guided nature walk for a closer encounter with the wild. Whether you're an adventure seeker, photographer, or nature lover, Murchison Falls National Park promises an extraordinary experience that combines nature’s raw beauty with thrilling wildlife encounters.</p>
