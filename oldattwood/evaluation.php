    ...
    <div class="col-md-8 contact-page-head-border">
      ...
      <div class="row">
        ...
        <div class="col-md-11" style="padding:0;">
          ...
          <!--Message-->
          <div class="col-sm-6 col-md-12 black"> <span class="input input--nariko">
            <input class="input__field input__field--nariko" name="dob" type="date" id="input-20" style="background-color:transparent;" />
            <label class="input__label input__label--nariko" for="input-20"> <span class="input__label-content input__label-content--nariko">Date of Birth</span> </label>
            </span> </div>
...
<select name="gender" class="form-control" id="gender">
            ...
            <label class="input__label input__label--nariko" for="input-20"> <span class="input__label-content input__label-content--nariko">Gender</span> </label>
            </span> </div>

<div class="col-sm-6 col-md-6 black"> <span class="input input--nariko">
            <input class="input__field input__field--nariko" type="text" name="interests" id="input-20" style="background-color:transparent;" />
            <label class="input__label input__label--nariko" for="input-20"> <span class="input__label-content input__label-content--nariko">Tour  Interests</span> </label>
            </span> </div>
...
<select name="country" class="form-control" id="gender">
                ...
                <option value="Selfdrive Packages">Self Drive Packages</option>
                <option value="Day Trips & Hikes">Day Trips & Hikes</option>
                <option value="Team Building">Team Building</option>
                <option value="Honeymoon">Honeymoon Packages</option>
                <option value="Bush Birthday">Bush Birthday</option>
            ...
            <label class="input__label input__label--nariko" for="input-20"> <span class="input__label-content input__label-content--nariko"></span>Interests </label>
            </span> </div>
      ...
      <div class="row margin-top">
        <div class="col-md-offset-2 col-md-10">
          ...
          <div class="contact-det">
            ...
            <span>PHONE <br />
            <p style="margin-bottom:8px;"><b>PHONE: +254775297806</b></p>
            <p><b>PHONE 2: +254788089228.</b></p>
            </span> </div>
          <div class="contact-det">
            <div class="contact-icon"><i class="flaticon-envelope"></i></div>
            <span>EMAIL <br />
            <p>info@Joyviztours.com</p>
            </span> </div>
          <div class="contact-det">
