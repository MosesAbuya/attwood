...
<section id="page-title" style="background: url('img/ruwe1.jpg') center center no-repeat; background-size: cover;">
  <div class="story-head text-center">
    <div class="story-head-black">
      <div class="container">
        <h2>Uganda Packages</h2>
        <p>Make People Fullfill their dreams!</p>
        <span><a href="index.php">HOME</a> > <a href="#">Uganda Packages</a> > <b class="content-subhead">Welcome</b></span> </div>
    </div>
  </div>
</section>
  <!--TOP-->
  ...
  <!-- Image -->
  <img id="sliderImage" src="img/ruwe1.jpg" 
...
<script>
  const images = ["img/murchison2.jpg", "img/ruwe2.jpg", "img/murchison1.jpg"];
  let currentIndex = 0;
  ...
  setInterval(() => {
    changeSlide(1);
        ...
        <div>
          ...
          <h3>Discover Details About Uganda Packages</h3>
      
          <p class="article-body-span" style="margin-right:0; margin-top:15px;">Discover the beauty and adventure of Uganda, often referred to as the "Pearl of Africa." Our Uganda packages offer unforgettable experiences including gorilla trekking in Bwindi Impenetrable Forest, chimpanzee tracking in Kibale National Park, and breathtaking game drives in Queen Elizabeth National Park. Whether you're cruising along the Kazinga Channel or exploring the mighty Murchison Falls, Uganda provides a rare combination of wildlife, natural beauty, and cultural richness.</p>

          <p class="article-body-span">Our curated tours also take you to the serene Lake Bunyonyi, the mystical Rwenzori Mountains, and the vast savannahs of Kidepo Valley. Enjoy personalized itineraries, professional guides, and comfortable accommodations as you connect with Uganda’s friendly people and vibrant traditions. Whether you're a nature lover, adventurer, or cultural explorer, Uganda is a destination that will leave you inspired and fulfilled.</p>
