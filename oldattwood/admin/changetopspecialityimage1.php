...
<html lang="en">
    <head>
        <title>Admin | Edit Top Speciality</title>
                ...
                <div class="main-content" >
                    <div class="wrap-content container" id="container">
                        ...
                        <section id="page-title">
                            <div class="row">
                                <div class="col-sm-8">
                                    <h1 class="mainTitle">Admin | Edit Top Speciality</h1>
                                                                    </div>
                                <ol class="breadcrumb">
                                    <li>
                                        <span>Admin</span>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            <div class="panel panel-white">
                                                <div class="panel-heading">
                                                    <h5 class="panel-title">Edit Top Speciality</h5>
                                                </div>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title"><b>Current TopSpeciality Image</b></h4>
