...
{
	$doctorspecilizationid=$_POST['Doctorspecialization'];
...
$sql=mysqli_query($con,"insert into doctors(doctorspecilizationid,doctorName,address,docFees,contactno,doctorsimage,docEmail,password) values('$doctorspecilizationid','$docname','$docaddress','$docfees','$doccontactno','$imgnewfile','$docemail','$password')");
if($sql)
{

$_SESSION['msg']="Doctor info added Successfully !!";
}
else{
...
<?php $ret=mysqli_query($con,"select id,specilization from doctorspecilization");
while($row=mysqli_fetch_array($ret))
{
?>
<option value="<?php echo htmlentities($row['id']);?>"><?php echo htmlentities($row['specilization']);?>
																</option>
																<?php } ?>
...
<div class="form-group">
					...
					<textarea name="clinicaddress" class="form-control"  placeholder="Enter Your Clinic Name or Location (e.g Zawadi Clinic, Nairobi)" required="true"></textarea>
														</div>
<div class="form-group">
															<label for="fess">
