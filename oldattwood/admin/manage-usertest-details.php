...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from medicaltestusers where id = '".$_GET['id']."'");
...
<head>
        ...
        <title>Admin - Manage Medical Test Users</title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | Manage Medical Tests</h3>
																	</div>
						...
						<div class="col-12">
							...
							<div class="card card-table">
								<div class="card-header">
									<h5 class="over-title margin-bottom-15" style="color: green">Manage <span class="text-bold">Medical Tests Users</span></h5>
...
$sql=mysqli_query($con,"select medicaltestusers.*, relatedtest.rname from medicaltestusers join relatedtest on relatedtest.testnameID=medicaltestusers.rnameID");
$cnt=1;
...
<td><?php echo $row['pickupcharges'];?></td>
...
<a href="manage-patient.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-sm bg-danger-light">
