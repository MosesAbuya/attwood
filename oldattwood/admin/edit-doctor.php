...
$sql=mysqli_query($con,"Update doctors set doctorspecilizationid='$doctorspecilizationid',doctorName='$docname',address='$docaddress',docFees='$docfees',contactno='$doccontactno',docEmail='$docemail' where id='$id'");
if($sql)
{
...
<br /> <br />
<a href="cdoctorimage.php?id=<?php echo htmlentities($data['id']);?>">Update Image</a>
</div>
</div>
</div>
