...
?>
			...
			<div class="card card-table">
								<div class="card-header">
									<h3 class="mainTitle">Admin | Manage Top Specialities</h3>
																	</div>
			<div class="card-body">
...
?>
	...
	<a href="edit-topspeciality.php?id=<?php echo $row['id'];?>" class="btn btn-sm bg-success-light">
																				<i class="far fa-edit"></i> Edit
																			</a>
<a href="manage-topspeciality.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-sm bg-danger-light">
