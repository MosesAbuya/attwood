...
if(isset($_POST['submit'])) {
    ...
    if(!in_array($extension, $allowed_extensions)) {
        ...
        if(move_uploaded_file($_FILES["simage"]["tmp_name"], "postimages/" . $imgnewfile)) {
            ...
            $sql = "INSERT INTO blog(title, subtitle, blogcontent, simage) VALUES ('$title', '$subtitle', '$blogcontent', '$imgnewfile')";
        ...
        <div class="page-wrapper">
            <div class="content container-fluid">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h3 class="mainTitle">Admin | Add Blog</h3>
                        </div>
                    </div>
                </section>
                                ...
                                <div class="panel panel-white">
                                    <div class="panel-body">
                                        ...
                                        <form role="form" name="adddoc" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label for="simage">Blog Image</label>
