                	...
                	<section id="page-title">
							<div class="row">
								...
								<div class="card-header">
									<h5 class="over-title margin-bottom-15" style="color: green">Manage <span class="text-bold">Completed Bookings</span></h5>
 ...
 else
 {
 	echo "In-progress";
										...
										?>									
																...
																<td><a href="completed_bookings.php?vid=<?php echo $row['id']?>&cancel=update" onclick="return confirm('Mark this testbooking as completed?')"><span class="badge badge-pill bg-info-light">Completed</span></a> /


<a href="completed_bookings.php?vvid=<?php echo $row['id']?>&cancel=update" onclick="return confirm('Mark this testbooking as In-progress?')"> <span class="badge badge-pill bg-danger-light">In-progress</span></a>
</td>
...
<a href="completed_bookings.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-sm bg-danger-light">
