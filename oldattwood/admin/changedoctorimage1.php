...
$query=mysqli_query($con,"update doctorspecilization set doctorsimage='$imgnewfile' where id='$catid'");
if($query)
{
$msg="Doctor Image updated ";
}
else{
...
<?php } ?>
                                ...
                                <?php
$catid=intval($_GET['id']);
$query=mysqli_query($con,"select doctorsimage from doctorspecilization where id='$catid'");
...
<img src="postimages/<?php echo htmlentities($row['doctorsimage']);?>" width="150"/>
<br />
