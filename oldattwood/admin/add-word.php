...
$sql=mysqli_query($con,"insert into words(name,meaning) values('$name','$meaning')");
if($sql)
{
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | Add Word </h3>
																	</div>
					...
					<input type="text" name="name" class="form-control"  placeholder="Enter Word" required="true">
														</div>
...
<div class="form-group">
					...
					<textarea name="meaning" class="form-control"  cols="20" placeholder="Write Meaning" required="true"></textarea>
														</div>
