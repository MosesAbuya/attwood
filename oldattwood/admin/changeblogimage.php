            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | Edit Blog Image</h3>
																	</div>
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title" align="center"><b>Current Blog Image</b></h4>
...
<div class="col-sm-12">
 <div class="card-box">
    <br />
<h5 style="color: blue" align="center" class="m-b-30 m-t-0 header-title">Browse new image</h5>
