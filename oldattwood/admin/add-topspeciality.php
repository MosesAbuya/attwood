            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | Add Top Speciality</h3>
																	</div>
...
<div class="form-group mb-0">
					...
					<textarea name="description" class="form-control" rows="5" placeholder="Write a brief description about this speciality" maxlength="120" required="true"></textarea>
