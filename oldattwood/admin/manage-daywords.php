...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from daywords where id = '".$_GET['id']."'");
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | Manage daywords</h3>
																	</div>
						...
						<div class="card card-table">
								<div class="card-header">
									<h5 class="over-title margin-bottom-15" style="color: green">Manage <span class="text-bold">daywords</span></h5>
								...
								<div class="table-responsive">
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from daywords");
$cnt=1;
...
?>
											...
											<tr>
												...
												<td class="hidden-xs"><?php echo $row['meaning'];?></td>
	...
	<a href="edit-dayword.php?id=<?php echo $row['id'];?>" class="btn btn-sm bg-success-light">
																				<i class="far fa-edit"></i> Edit
																			</a>
<a href="manage-daywords.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-sm bg-danger-light">
