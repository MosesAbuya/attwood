				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Contact</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Update Contact Info</h5>
												</div>
...
<div class="form-group">
					...
					<textarea name="mission" class="form-control"  cols="5" required="true"> <?php echo htmlentities($row['mission'])?></textarea>
														</div>			
					...
					<textarea name="welcomenote" class="form-control"  cols="5" required="true"> <?php echo htmlentities($row['welcomenote'])?></textarea>
														</div>								
