...
if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from relatedtest where id = '".$_GET['id']."'");
                  $error="Related test record deleted successfully!!";
		  }
?>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
								<h3 class="mainTitle">Admin | Related Tests</h3>			</div>
								...
								<div class="card-header">
									<h5 class="over-title margin-bottom-15" style="color: green">Manage <span class="text-bold">Related Tests</span></h5>
...
<?php } ?>
	...
	<table class="datatable table table-hover table-center mb-0">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select relatedtest.*,tests.testname from relatedtest join tests on relatedtest.testnameID=tests.id");
$cnt=1;
...
?>
											...
											<tr>
												...
												<td class="hidden-xs"><?php echo $row['rname'];?></td>
	...
	<a href="edit_relatedtest.php?id=<?php echo $row['id'];?>" class="btn btn-sm bg-success-light">
																				<i class="far fa-edit"></i> Edit
																			</a>
<a href="manage_relatedtests.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-sm bg-danger-light">
