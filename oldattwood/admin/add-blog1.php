...
$sql=mysqli_query($con,"insert into blog(title,subtitle,blogcontent,simage) values('$title','$subtitle','$blogcontent','$imgnewfile')");
if($sql)
{
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Add Blog</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
					...
					<input type="text" name="subtitle" class="form-control"  placeholder="Enter Sub Title (20-30 words)" required="true">
														</div>
...
<div class="form-group">
					...
					<textarea name="blogcontent" class="form-control"  cols="20" placeholder="Write blog content" required="true"></textarea>
														</div>
