...
$query=mysqli_query($con,"update tests set testimage='$imgnewfile' where id='$catid'");
if($query)
{
$msg="Test Image updated ";
}
else{
...
<head>
     ...
     <title>Admin | Edit Test Image</title>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | Edit Test Image</h3>
																	</div>
...
<?php } ?>
                                ...
                                <?php
$catid=intval($_GET['id']);
$query=mysqli_query($con,"select testimage from tests where id='$catid'");
...
<div class="col-sm-12">
 <div class="card-box">
<h4 class="m-b-30 m-t-0 header-title" align="center"><b>Current Test Image</b></h4>
