            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | Manage Blogs</h3>
																	</div>
						...
						<div class="card card-table">
								<div class="card-header">
									<h5 class="over-title margin-bottom-15" style="color: green">Manage <span class="text-bold">Blogs</span></h5>
...
?>
	...
	<a href="edit-blog.php?id=<?php echo $row['id'];?>" class="btn btn-sm bg-success-light">
																				<i class="far fa-edit"></i> Edit
																			</a>
<a href="manage-blog.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-sm bg-danger-light">
