...
$query=mysqli_query($con,"insert into tblcity(cityname) values('$cityname')");
if($query)
{
...
?>
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h4 class="mainTitle">Admin | Add City</h4>
																	</div>
			...
			<div class="card card-table">
								<div class="card-header">
									<h5 class="over-title margin-bottom-15" style="color: green">Manage <span class="text-bold">Cities</span></h5>
				...
				<thead>
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from tblcity");
$cnt=1;
...
?>
											...
											<tr>
												...
												<td class="hidden-xs"><?php echo $row['cityname'];?></td>
	...
	<a href="edit_city.php?id=<?php echo $row['id'];?>" class="btn btn-sm bg-success-light">
																				<i class="far fa-edit"></i> Edit
																			</a>
<a href="add_city.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-sm bg-danger-light">
