            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | Edit Doctor Specilization</h3>
																	</div>
												...
												<form role="form" name="dcotorspcl" method="post" enctype="multipart/form-data">
														<div class="form-group">
															<label for="exampleInputEmail1">
																<b>Edit Doctor Specialization</b>
															</label>
...
<div class="col-sm-12">
 <div class="card-box">
<center><h5 class="m-b-30 m-t-0 header-title"><b>Current Image</b></h5></center>
<center><img src="postimages/<?php echo htmlentities($row['doctorsimage']);?>" width="150"/></center>
<br /> <br />
<a href="changedoctorimage.php?id=<?php echo htmlentities($row['id']);?>"><center><u style="color: blue">Update Image</u></center></a>
</div>
</div>
</div>
