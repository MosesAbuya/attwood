...
$sql=mysqli_query($con,"Update blog set title='$title',subtitle='$subtitle',blogcontent='$blogcontent' where id='$id'");
if($sql)
{
            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | Edit Blog </h3>
																	</div>
						...
						<div class="card card-table">
								<div class="card-header">
									<h5 class="over-title margin-bottom-15" style="color: green">Edit Blog <span class="text-bold"></span></h5>
...
<hr />
    ...
    <input type="text" name="subtitle" class="form-control" value="<?php echo htmlentities($data['subtitle']);?>" >
                                                        </div>
...
<div class="form-group">
                    ...
                    <textarea name="blogcontent" rows="10" class="form-control"><?php echo htmlentities($data['blogcontent']);?></textarea>
                                                        </div>
...
<br /> <br />
<a href="changeblogimage.php?id=<?php echo htmlentities($data['id']);?>"><u style="color: blue" >Update Image</u></a>
</div>
</div>
</div>
