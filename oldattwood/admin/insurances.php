            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h4 class="mainTitle">Admin | Add In-network Insurance Cover</h4>
																	</div>
													...
													<form role="form" name="dcotorspcl" method="post" enctype="multipart/form-data">
														<div class="form-group">
															<label for="exampleInputEmail1">
																<b>Name of the Insurance Cover</b>
															</label>
				...
				<div class="card card-table">
								<div class="card-header">
									<h5 class="over-title margin-bottom-15" style="color: green">Manage <span class="text-bold">In-network Insurance Cover</span></h5>
...
<a href="edit-insurancecover.php?id=<?php echo $row['id'];?>" class="btn btn-sm bg-success-light">
																				<i class="far fa-edit"></i> Edit
																			</a>
<a href="insurances.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" class="btn btn-sm bg-danger-light">
