            ...
            <div class="page-wrapper">
                ...
                <div class="content container-fluid">
                	<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h3 class="mainTitle">Admin | About Us</h3>
																	</div>
...
?>
                  ...
                  <option value="terms&conditions.php?type=terms">terms and condition</option>
                  <option value="terms&conditions.php?type=privacy">privacy and policy</option>
                  <option value="terms&conditions.php?type=aboutus">aboutus</option> 
                  <option value="terms&conditions.php?type=faqs">FAQs</option>
                </select>
												</div>
											</div>
