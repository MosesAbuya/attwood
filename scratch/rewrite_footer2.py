...
<footer class="aw-footer-modern">
  ...
  <div class="aw-footer-newsletter-layer" style="background: url('oldattwood/img/slider/slide4.jpg') center/cover; position: relative;">
    <div class="aw-footer-newsletter-overlay" style="position: absolute; inset: 0; background: rgba(0,0,0,0.6); z-index: 1;"></div>
...
print("Rewrote footer.php with straddle layout.")
