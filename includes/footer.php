...
<footer class="aw-footer-modern">
  <!-- Layer 1: Newsletter Top (Image Background) -->
  <div class="aw-footer-newsletter-layer" style="position: relative; margin-top: -20px; z-index: 100;">
    
    <!-- Background and Overlay Container (Handles clipping safely) -->
    <div style="position: absolute; inset: 0; border-radius: 20px 20px 0 0; overflow: hidden; z-index: 1;">
       <div style="position: absolute; inset: 0; background: url('oldattwood/img/slider/slide4.jpg') center/cover;"></div>
       <div style="position: absolute; inset: 0; background: rgba(0,0,0,0.6);"></div>
    </div>
    
    <div class="container text-center position-relative" style="z-index: 2;">
      <h2 class="aw-footer-title text-white">Subscribe to our newsletter</h2>
      <p class="aw-footer-subtitle text-white-50">Sign up today and get exclusive safari itineraries and offers.</p>
      ...
      <div class="aw-footer-experts mt-4 d-flex align-items-center justify-content-center gap-2">
        <span style="font-size:12px; font-weight:500; color:#ddd;">Our experts are ready to help!</span>
        <div class="aw-expert-avatars d-flex">
           <img src="oldattwood/img/slider/slider-1.jpg" alt="Expert" style="width:28px; height:28px; border-radius:50%; border: 2px solid #fff; object-fit:cover; margin-right:-8px; position:relative; z-index:3;">
           <img src="oldattwood/img/slider/slider-2.jpg" alt="Expert" style="width:28px; height:28px; border-radius:50%; border: 2px solid #fff; object-fit:cover; margin-right:-8px; position:relative; z-index:2;">
           <img src="oldattwood/img/slider/slider-3.jpg" alt="Expert" style="width:28px; height:28px; border-radius:50%; border: 2px solid #fff; object-fit:cover; position:relative; z-index:1;">
        </div>
      </div>
    </div>

    <!-- Layer 2: Floating Banner Straddling the Boundary -->
    <div class="aw-banner-wrapper">
      <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          <div class="aw-footer-brand">
            <img src="oldattwood/img/logo.png" alt="Attwood Travel Agency" class="aw-footer-base-logo" style="filter: brightness(0) invert(1); max-height:40px;">
          </div>
          <div class="aw-footer-address mt-4">
            <p>Attwood Travel Agency Ltd<br>Nairobi, Kenya<br>East Africa</p>
            
            <div class="d-flex flex-column gap-3 mt-4 aw-contact-block">
              <div>
        ...
        <div class="col-lg-8">
          <div class="row">
            <div class="col-6 col-md-4 mb-4 aw-footer-links-col">
            ...
            <div class="col-12 col-md-4 mb-4 aw-footer-links-col">
...
<?php include_once __DIR__ . '/start-planning-modal.php'; ?>
